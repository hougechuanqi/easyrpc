...
public class StringUtils {
	 ...
	 * trailing whitespace on each value. Duplicate and empty values are
	 * removed.
	 * 
	 * @param str
	 ...
	 *
	 * @param name
	 *            Name of the option to remove. Example: -foo.
	 * @param args
	 *            List of arguments.
	 * @return null if the option was not found; the value of the option
	 *         otherwise.
	 * @throws IllegalArgumentException
	 *             if the option's argument is not present
	 */
	 ...
	 * argument. Non-option arguments are those which either come after a double
	 * dash (--) or do not start with a dash.
	 *
	 * @param args
	 *            List of arguments.
	 ...
	 *
	 * @param s1
	 *            Non-null string to be converted
	 * @param s2
	 *            string to be converted
	 * @return the str, converted to uppercase.
	 */
