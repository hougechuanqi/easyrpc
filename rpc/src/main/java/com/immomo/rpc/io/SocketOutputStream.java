...
public class SocketOutputStream extends OutputStream implements
	 ...
	 * {@link FileChannel#transferTo(long, long, WritableByteChannel)}. Updates
	 * <code>waitForWritableTime</code> and <code>transferToTime</code> with the
	 * time spent blocked on the network and the time spent transferring data
	 * from disk to network respectively.
	 * 
	 ...
	 * @param waitForWritableTime
	 *            nanoseconds spent waiting for the socket to become writable
	 * @param transferTime
	 *            nanoseconds spent transferring data
	 * 
	 * @throws EOFException
...
//	}
	 ...
	 * with null <code>waitForWritableTime</code> and
	 * <code>transferToTime</code>
	 */
//	public void transferToFully(FileChannel fileCh, long position, int count)
//			throws IOException {
